...
public class RoomPricesLandingPage
{
	...
	@FindBy(xpath="//table[@class='table_price']//tr[2]//td[3]//tr")
	...
	public  String get_LastMinRate() throws Exception
	{
		try
		{
			...
			int count1=GenericMethods.tr_count(count);
			for(int i=4;i<=count1;i++)
			{
				String str=GenericMethods.driver.findElement(By.xpath("//table[@class='table_price']//tr[2]//td[3]//tr["+i+"]/td")).getText();
				arr.add(str.split("\n")[0]);
				if(str.contains("Last Min Rate"))
				{
					Assert.assertTrue(str.contains("Last Min Rate"));
					price=GenericMethods.driver.findElement(By.xpath("//table[@class='table_price']//tr[2]//td[3]//tr["+i+"]//td[2]//input")).getAttribute("value");
	...
	public String verify_RTPublishedOnWeb(int iTestCaseRow) throws Exception
	{
		try
		{
			ArrayList<String> arr=new ArrayList<String>();
	      ...
	      for(int i=4;i<=count1;i++)
	      {
	    	  String data=GenericMethods.driver.findElement(By.xpath("//table[@class='table_price']//tr[2]//td[3]//tr["+i+"]/td")).getText();
	    	  arr.add(data.split("\n")[0]);
	    	  if(data.contains("Last Min Rate"))
	    	  {

	    		  Assert.assertTrue(data.contains("Last Min Rate"));
	    		  WebElement ele=GenericMethods.driver.findElement(By.xpath("//table[@class='table_price']//tr[2]//td[3]//tr["+i+"]//td//img"));
	    		  ele.click();
	    		  //WebElement ele1=GenericMethods.driver.findElement(By.xpath("//table[@class='table_price']//tr[2]//td[3]//tr["+i+"]//td[8]/input"));
	    		  price=GenericMethods.driver.findElement(By.xpath("//table[@class='table_price']//tr[2]//td[3]//tr["+i+"]/td[2]/input")).getAttribute("value");
	    		  //boolean value=ele1.isSelected();
	    		  if(price.equals("0.00"))
	    		  {
	    			  Assert.assertEquals(price.equals("0.00"), true);
		    		  WebElement ele1=GenericMethods.driver.findElement(By.xpath("//table[@class='table_price']//tr[2]//td[3]//tr["+i+"]/td[2]/input"));
                      ele1.clear();
		    		  ele1.sendKeys(ExcelUtil.getCellData(iTestCaseRow, ExcelUtil.GetColumnIndex(Constant.Col_LastMinRate)));
		    		  GenericMethods.driver.findElement(By.xpath("//table[@class='table_price']//tr[2]//td[3]//tr["+i+"]//td//img[3]")).click();
		    		  //lastmin_save.click();
                      //GenericMethods.driver.navigate().to("http://hotelogix.stayezee.com/webreservation/index/index/hidHotelIdWebOut/QV5TX0ZSczM0XzEyOTAzX0Y1dGVyOTA4N3NfKWRoZl9kcnRlcjdfMTI5MDNfaGdmaF9nXmQ4NTQ=/hidLanguageId/1/");
	    		  }
