...
public class BasePage
{
    ...
    @FindBy(xpath="//header[@id='header']//div//span")
	...
	@FindBy(xpath="//a[text()='Add-ons (Inclusions)']")
    ...
    @FindBy(xpath="//*[@id='jsddm']/li[2]/ul/li[34]/a")
	public static WebElement Discounts;
    
    
    @FindBy(xpath="//header[@id='header']//a//img")
	public static WebElement Home;
  
    
    @FindBy(xpath="(//a[text()='Special Discounts'])[3]")
    ...
    public void fn_NavigatingBackToHome() throws Exception
    {
    	GenericMethods.clickElement(Home);;
    }
...
//xpath for Room Types
		...
		//Navigate to Rooms Page
				public RoomsLandingPage roomsPageNavigate() throws Exception
				{
					...
					GenericMethods.mouseOverElement(roommanager);
					Thread.sleep(3000);
					GenericMethods.clickElement(roommanager);
					Thread.sleep(3000);
               ...
               public Discounts_SpecialDiscountLP fn_navigateSpclDiscount() throws Exception
               {
            	...
            	/*   GenericMethods.mouseOverElement(General);
            	   GenericMethods.javascriptScroll(Discounts);
            	   Thread.sleep(4000);
            	   GenericMethods.mouseOverElement(Discounts);
            	 //  GenericMethods.js_scroll(Discounts);
            	   Thread.sleep(1000);
            	*/   try
            	   {
            	  /* GenericMethods.mouseOverElement(Discounts);
