...
public WebGuestConfirmReservationPrintPage ConfirmBooking(int iTestCaseRow) throws Exception{
	...
	GenericMethods.sendKeys(CVCTextField, ExcelUtil.getCellData(iTestCaseRow, ExcelUtil.GetColumnIndex(Constant.Col_CVC)));
	GenericMethods.sendKeys(ExpiryMonthTextField, ExcelUtil.getCellData(iTestCaseRow, ExcelUtil.GetColumnIndex(Constant.Col_ExpiryMonth)));
	GenericMethods.sendKeys(ExpiryYearTextField, ExcelUtil.getCellData(iTestCaseRow, ExcelUtil.GetColumnIndex(Constant.Col_ExpiryYear)));
